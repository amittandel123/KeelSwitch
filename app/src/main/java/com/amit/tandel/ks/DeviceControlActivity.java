...
public class DeviceControlActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnCharge = (Button)findViewById(R.id.buttonCharge);
...
/*      mConnectionState.setVisibility(View.INVISIBLE);
        ...
        btnCharge.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mBluetoothLeService != null) {
                    ...
                    Toast.makeText(getApplicationContext(),"Charging Started",Toast.LENGTH_SHORT).show();
    ...
    private BroadcastReceiver mBatInfoReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context c, Intent i) {
            ...
            if (level == 100) {
                Toast.makeText(getApplicationContext(),"Battery 100% Charged",Toast.LENGTH_SHORT).show();
                Toast.makeText(getApplicationContext(),"Disconnecting Charger",Toast.LENGTH_SHORT).show();
                if (mBluetoothLeService != null) {
